...
public abstract class AbstractDecodeur<R, E> implements DestinationInterface<R>, SourceInterface<E> {
    /**
     * Liste des destinations connectées à la sortie du décodeur.
     * Ces destinations recevront l'information après décodeur.
     */
    protected List<DestinationInterface<E>> destinationsConnectees;

    /**
     * L'information reçue en entrée du décodeur.
     */
    protected Information<R> informationRecue;

    /**
     * L'information émise en sortie du décodeur après traitement.
     */
